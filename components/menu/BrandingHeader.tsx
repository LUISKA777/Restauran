...
export function BrandingHeader({ name, settings }: BrandingHeaderProps) {
  return (
    <header className="p-6 text-center space-y-2">
      <div className="w-20 h-20 bg-[var(--color-primary)] rounded-full mx-auto mb-4 flex items-center justify-center text-white font-bold text-2xl shadow-lg overflow-hidden">
        {settings?.logoUrl ? (
