...
export function BrandingHeader({ name, settings }: BrandingHeaderProps) {
  return (
    <header className="p-6 text-center space-y-2 relative z-10">
      <div className="w-24 h-24 bg-white/10 backdrop-blur-md rounded-full mx-auto mb-4 flex items-center justify-center text-white font-bold text-2xl shadow-2xl overflow-hidden border-4 border-white/20 ring-4 ring-[var(--color-primary)]/30">
        {settings?.logoUrl ? (
      ...
      <p className="text-white/50 text-sm font-medium italic opacity-80">
